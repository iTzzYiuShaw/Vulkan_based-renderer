...
struct SimpleModel
{
	...
	//Store all textured mesh, for each mesh, it starts by vertexStartIndex,
	//owning vertexCount of vertices.

	//Each mesh owns a texture with a material (difusscolor), 
	//others use solid color (difuse color also)
	struct Data_
	{
